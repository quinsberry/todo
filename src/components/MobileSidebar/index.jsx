...
import { List, AddListButton } from '../../components';


const MobileSidebar = ({ activeItem, history, lists, setLists, onAddList, colors, isOpened, toggleSidebar }) => {


  return (
    <div className={classNames("todo__sidebar", { 'active': isOpened })}>
      <div className="openSidebar" onClick={toggleSidebar}></div>
      <List
